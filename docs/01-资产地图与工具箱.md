...
![资产风险光谱](../assets/asset-risk-spectrum.svg)
...
**Key takeaways:**
- Assets form a risk spectrum: **cash → bonds → broad indexes → sector/active funds → single stocks → derivatives**.
- There is no single "best" asset — only the mix that fits your horizon and risk tolerance.
- Manage money in three buckets: **emergency (cash) / preservation (bonds) / growth (equity)**.
- **Risk ≠ volatility**: volatility is temporary and time can smooth it; *permanent loss* (bankruptcy, leverage blow-up) is the real risk.
- The longer your horizon, the less volatility behaves like risk.
